---
title: Looking Ahead to the 2020 Elections
publishedAt: '2020-07-10'
tags: 'politics, philosophy'
summary: 'The principles that should guide us when voting, and what that means for November.'
---

Other than your mind, the most powerful tool you possess is your **voice.** Representation in a free society is literally life or death - our lives can go in one direction or another depending on the quality of our public servants. Who we elect into office directly impacts how much we pay in taxes, our social freedoms (drugs, guns, marriage, etc.), and our relationships with other countries (which affects the availability and prices we pay on products that other countries produce).
...
During elections, those who do vote tend to vote against a specific candidate rather than voting in favor of one. People say: "Well that guy's a crazy liberal so I'm going to vote for Trump" or "Well I think Trump is insane so I'll probably go with Biden even though I don't care much for his policies."

For most, they are choosing the "lesser of two evils" - i.e. the person they hate _less._
...
President Trump has made a few quality decisions that I agree with. These include either the undoing of poor choices made by the Obama administration or the restoration of freedoms to corporations and individuals. Here a few of his commendable accomplishments:
...
Deciding to terminate a pregnancy or not is a serious decision, but it is ultimately the woman's choice. Trump disagrees. His position on abortion is an incorrect and immoral one.
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">✋ "Tuition-free" is an oft-used, but misleading term.</h3>
  </div>
  <p>
    I place quotes around "tuition-free" because the money must be confiscated from taxpayers in
    order to fund the program (like all government programs). And like the energy sector, government
    should have no role in the education system.
  </p>
</div>
