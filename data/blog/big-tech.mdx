...
<div className="calloutInfo">
  <h3>✋ Hey, why did you put "monopoly" in quotes?</h3>
  <p>
...
<div className="calloutInfo">
  <h3>🔔 I wrote an article on self-driving cars too!</h3>

  <p>
    I'm taking this opportunity to plug my <a href="/blog/autonomous-vehicles">article</a>
...
<div className="calloutInfo">
  <h3>❤️ We need to change the narrative surrounding Big Tech.</h3>
  <p>
