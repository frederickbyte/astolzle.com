...
But the problems we face are not a result of Big Tech's supposed "influence over us" - they are a result of <span className="color-quinary-shade"><b>bad philosophic ideas</b></span> that our society has accepted.
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">📚 What we will discuss:</h3>
  </div>
  <ol>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">✋ Hey, why did you put "monopoly" in quotes?</h3>
  </div>
  <p>
...
<div className="border-2 border-gray-700 bg-gray-50 dark:bg-black p-10 flex items-center justify-center">
  <div className="bg-white dark:bg-gray-800 p-4 rounded-xl max-w-xl">
    <div className="flex justify-between">
      <div className="flex items-center">
        <div className="ml-1.5 text-sm leading-tight">
          <span className="text-black dark:text-white font-bold block ">Ben Shapiro</span>
          <span className="text-gray-500 dark:text-gray-400 font-normal block">@benshapiro</span>
        </div>
      </div>
    ...
    <a href="https://twitter.com/benshapiro/status/1348293627731177481?ref_src=twsrc%5Etfw" aria-label="twitter link" className="text-gray-500 dark:text-gray-400 underline-offset-4 hover:underline text-base mb-0 pb-0">January 10, 2021</a>
  </div>
</div>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">✋ You put "censorship" in quotes too?</h3>
  </div>
 <p>Yes, because censorship is also used incorrectly.</p>
  <p>
    I surround "censorship" in quotes because Republicans such as Shapiro use it incorrectly when
    criticizing private companies.
  </p>
  <p>
    <em>Censorship does not apply to private entities, only to governments.</em> When Twitter or
    Facebook blocks a post, they are not "censoring" that user. An individual has no right to post
    whatever they want on Twitter's platform. Creating an account does <u>not</u> magically make that
    user the CEO of Twitter.
  </p>
  <p>
    A social media company should not have to bow to the whims of a specific user. Each user must
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">Corporations are people.</h3>
  </div>
  <p>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">🔔 I wrote an article on self-driving cars too!</h3>
  </div>
  <p className="mb-0">
    I'm taking this opportunity to plug my <a href="/blog/autonomous-vehicles">post</a> on autonomous vehicles if you are curious.
  </p>
</div>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">❤️ We need to change the narrative surrounding Big Tech.</h3>
  </div>
    <p>
  ...
  <ul>
    ...
    <li>
      Buy smartphones, smartwatches, tablets, laptops, desktops, and 4K TVs at prices nearly
      everyone can afford
    </li>
...
<ol>
  ...
  <li>
    Forcing Google and other search engines to give news publishers (but not the average user) a 14
    day notice of algorithm changes
  </li>
  <li>
    Giving the Australian goverment the final say in arbitrating negotiations between search engines
    and other entities
  </li>
</ol>
