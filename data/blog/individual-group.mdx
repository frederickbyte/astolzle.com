...
summary: 'Is it right to limit freedoms in the name of protecting public health?'
---
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">In Summary</h3>
  </div>
  <ol>
    <li>All individuals have a right to their life</li>
    <li>This right is absolute and cannot be surrendered under any circumstance</li>
    <li>This right is independent of race, ethnicity, religion, and gender</li>
    <li>
      Individuals have the right to take action to maintain or improve their lives, so long as that
      action does not violate another person's life or property
    </li>
    <li>
