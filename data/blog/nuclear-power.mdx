...
<div className="calloutInfo">
  <h3>✋ Why did you put quotes around "climate change"?</h3>
...
<div className="calloutInfo">
  <h3>⚠️ Common concerns regarding nuclear power:</h3>
...
<div className="calloutInfo">
  <h3>⚠️ Death rates from energy production per TWh</h3>
  
  <p>
    Death rates from air pollution and accidents related to energy production,
    measured in deaths per terawatt hours (TWh) <a href="https://ourworldindata.org/grapher/death-rates-from-energy-production-per-twh">(source)</a>
  </p>
...
<aside className="calloutInfo">
  <h3>⚡ Nuclear power will change the world</h3>
