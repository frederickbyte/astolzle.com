...
tags: 'politics, tech'
summary: 'Why the West should embrace nuclear fission.'
---

We all want to live in a world of clean air, clear water, and uncontaminated food. People want to live comfortably. But this requires energy - and _lots_ of it.
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">✋ Why did you put quotes around "climate change"?</h3>
  </div>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">⚠️ Common concerns regarding nuclear power:</h3>
  </div>
 <ul>
...
![Source: U.S. Energy Information Administration](../../static/images/capacity_factor.png)
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">Why is energy density valuable?</h3>
  </div>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">⚠️ Death rates from energy production per TWh</h3>
  </div>
 <p>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">⚡ Nuclear power will change the world</h3>
  </div>
