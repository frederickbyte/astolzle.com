...
tags: 'tech'
summary: 'Robots drive more safely than humans - they will only get better.'
---
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">In this post, we’ll discuss:</h3>
  </div>
  <p>Autonomous vehicles are great, but not perfect. There are a few problems unique to them:</p>
  <ol>
    <li>
      Humans are unsafe and untrustworthy drivers
    </li>
    <li>
      Self-driving cars are currently safer than humans
    </li>
    <li>
      Autonomous vehicles will make roads safer and less congested
    </li>
    <li>
    Self-driving cars will only become safer and offer more luxurious riding experiences
    </li>
  </ol>
</div>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">🔔 This does not imply that we should ban or further regulate vehicles.</h3>
  </div>
  <p>
...
<div className="border-2 border-gray-700 p-4 mb-2 bg-white  dark:bg-gray-700" role="alert">
  <div className="flex items-center">
      <h3 className="my-0 text-lg font-medium text-gray-700 dark:text-gray-300">❗ Self-driving cars still face significant problems</h3>
  </div>
  <p>Autonomous vehicles are great, but not perfect. There are a few problems unique to them:</p>
  <ul>
    <li>
      <u>Perception</u>: how can we be confident that AVs are seeing <em>everything?</em>
    </li>
    <li>
      <u>Redundancy</u>: what happens if one or more sensors fail?
    </li>
    <li>
      <u>Security</u>: how can we prevent people from hacking AVs?
    </li>
  </ul>
</div>
